          ...
          <div className="left">
            ...
            <div className="paradiv">
              <p>
                ...
                ut illo nobis quo molestias vitae odio ea dolores voluptate,
                eligendi ducimus quos! Id corrupti totam quidem et sequi? Odio,
                perferendis.
              </p>
            </div>
          </div>
          ...
          <div className="boxes">
            <div className="box">
              ...
              <div className="right">
                ...
                <h3>CPU</h3>
                <p>Intel(R) Core(TM) i5-8365U (8) @ 4.10 GHz</p>
                <h3>GPU:</h3>
                <p> Intel UHD Graphics 620 @ 1.10 GHz [Integrated]</p>
              </div>
            </div>
            <div className="box">
              <div className="left">
                ...
                <p>
                  Im From A medical Background but trying to get into field of
                  tech
                </p>
